...
const FAQs = ({question, answer, handClick, index, answer_style, arrow_style}) => {
    return (
        <div className="bg-custompurple3/50 text-start border-[1.5px] border-custompurple2/50 rounded-xl lg:w-2/4 md:w-5/6 w-[90%]  py-3 px-4 flex flex-col items-start gap-3 cursor-pointer" onClick={() => handClick(index)}>
