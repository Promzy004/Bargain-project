        ...
        <div className="md:w-4/6 w-[95%]">
            <form action="" method="POST" className="w-full flex flex-col gap-3 items-center">
                <div className="flex flex-col gap-8 w-full">
                    ...
                    <textarea name="message" cols="" rows="" placeholder="Message" className="contact-input bg-custompurple3/5 px-2" ></textarea>
                </div>
                ...
                <input type="submit" value='Send Message' name="submit" className="w-2/4 py-2 bg-customPrimary hover:bg-customPrimary/80 duration-500 cursor-pointer text-lg text-white rounded-lg mt-7"/>
            </form>
        </div>
    );
}
